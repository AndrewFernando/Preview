<?php
	...
	$BACKUP_ORDER	= true;		
	$MERCHANT_TO	= "<72968022@continental.edu.pe>";		
	$MERCHANT_FROM	= "<72968022@continental.edu.pe>";	
	$MERCHANT_BCC 	= true;		
	$MERCHANT_DATE_FORMAT = "dd/mm/yyyy";	
	$CRLF 			= "\r\n";				
	$HTTP_PREFIX	= (false)?'https://':'http://';		
	$VO_CTR = "a2da90386d69a22576334b550530889d";					
	$MAX_PERIOD = -1;				
	$ORDER_EMAIL_ADD_URL = false;		
	$ACCOUNTS_URL = "";
	$COOKIE_ACCOUNT_INF = "2397-account_inf";
